...
1. Go to the [Security tab](https://github.com/Veldkornet/hyxi-cloud-api/security) of this repository.
4. Click on **Advisories**.
5. Click **Report a vulnerability** to open a private draft advisory.
