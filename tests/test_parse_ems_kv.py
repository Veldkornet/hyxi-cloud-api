...
def test_parse_ems_kv_happy_path():
    ...
    data = [
        ...
        {"moduleName": "Battery", "filedKv": [{"prop": "SOC", "value": "100"}]},
    ]
    expected = {"gridvoltage": "230.0", "frequency": "50.0", "soc": "100"}
...
def test_parse_ems_kv_invalid_module_type():
    ...
    data = [
        ...
        None,
        {
            ...
            "filedKv": [{"prop": "ValidProp", "value": "10"}],
        },
    ]
